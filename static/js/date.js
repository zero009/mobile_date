...
(function ($) {
    $.fn.date = function (options, Ycallback, Ncallback) {
		...
		var initY = 49;
        // var initY = parseInt((nowdate.getFullYear() + "").substr(2));
        ...
        function refreshDate() {
            ...
            monthScroll.refresh();
            dayScroll.refresh();
            resetInitDete(); console.log(initY);
        ...
        function resetInitDete() {
            ...
            initY = parseInt(that.val().substr(2, 2)); console.log(initY)
        ...
        function init_iScrll() {
			...
			// console.log($("#yearwrapper ul li:eq(" + indexY + ")").html(),$("#yearwrapper ul li:eq(" + indexY + ")").html().length,strY);初始年 strY=2016
			
            var strM = $("#monthwrapper ul li:eq(" + indexM + ")").html().substr(0, $("#monthwrapper ul li:eq(" + indexM + ")").html().length - 1);
			
			// console.log($("#monthwrapper ul li:eq(" + indexM + ")").html(),$("#monthwrapper ul li:eq(" + indexM + ")").html().length,strM); 初始月 strM=01
            ...
            if (m && m > 0) {
                ...
                switch (m) {
                    ...
                    case 12:
                        ...
                        break;
                    case 2:
                        dayCount = (y % 4 == 0) && (y % 100 != 0 || y % 400 == 0) ? 29 : 28;
                        break;
                    default:
                        dayCount = 30;
                        break;
